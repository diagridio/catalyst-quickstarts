...
```powershell
Invoke-RestMethod -Method Post -Uri 'http://localhost:8004/agent/run' -ContentType 'application/json' -Body '{"task": "Calculate the budget for a corporate event with venue, catering, and entertainment"}'
```
