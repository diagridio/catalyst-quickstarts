...
```text
== APP == Notification: Reservation trip-42 received for ABC123
...
== APP == Notification: Reservation trip-42 has completed! Reservation ABC123 confirmed. Confirmation code: BK-E0BEBD22
```
