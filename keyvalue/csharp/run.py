...
def main():
    ...
    parser.add_argument('--project-name', type=str, default="kv-csharp-project-local",
                        help="The name of the project to create/use.")
    parser.add_argument('--config-file', type=str, default="dev-kv-csharp-project-local.yaml",
